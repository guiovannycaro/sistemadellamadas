...
<html>
    <head>
        ...
        <script src="vista/usalientes/funciones.js"></script>
        <style>
            .col-1{
                display: flex;
    ...
    <body>
        <div class="container">
            ...
            <table class="table table-hover" style="width:70%">
                ...
                <?php
                foreach ($this->modelsalientes->Listar() as $dat) {


                    $datos = $dat->id . "||" . $dat->nombres . "||" . $dat->apellidos . '||' . $dat->idrol . "||" . $dat->correo;
                    ?>
                    <tbody>
                        <tr>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="field desc">
                                        <select class="form-control" id="rol" name="rol">
                                            ...
                                            <?php foreach ($this->modelsalientes->Listarroles() as $dat) { ?>
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                ...
                                <div class="form-group">
                                    <label class="control-label" for="inputPatient">Rol</label>
                                    <div class="field desc">
                                        <select class="form-control" id="rolu" name="rolu">
                                            <option value="" selected>Seleccione un Usuario .....</option>
                                            <?php foreach ($this->modelsalientes->Listarroles() as $dat) { ?>
                                                <option value="<?php echo $dat->id; ?>"><?php echo $dat->rol; ?></option>
                                            <?php } ?>
                    ...
                    $(document).ready(function () {
                        ...
                        $(document).on('click', '.add', function () {
                            $('#Registrar').click(function () {
                                ...
                                datos = "id=" + id + "&nombre=" + nombre + "&apellido=" + apellidos + "&rol=" + rol + "&correo=" + correo;

                                $.ajax({
                                    type: "POST",
                                    method: "post",
                                    url: 'salientes.php?s=Guardar',
                                    data: datos,
                        ...
                        $(document).on('click', '.drop', function () {
                            ...
                            $('#Eliminar').click(function () {
                                ...
                                $.ajax({
                                    ...
                                    error: function (data) {
                                        alertify.alert('Mensaje Informativo', 'se no elimino el registro', function () {
                                            alertify.success('No Ok');
                                        });
